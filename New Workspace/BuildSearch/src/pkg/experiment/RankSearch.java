...
public class RankSearch {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    Query tq = new QueryParser("firstname", new StandardAnalyzer()).parse("Vipul"); //27 hits
		//TopDocs hits = isearcher.search(tq, 100);
		SortField sortField=new SortField("lastname",Type.STRING);
		Sort s = new Sort(sortField);
		TopFieldDocs hit = isearcher.search(tq, 100, s);
